...
prompt = """Сгенерируй Java Selenium тест для следующего сценария:
...
# Генерация текста
generated_text = model_client.generate_text(prompt=prompt, max_tokens=2000, temperature=0.2)
